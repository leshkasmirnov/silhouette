...
import ru.rybinsk.silhouette.binding.BasicCellSpanTableUI;
import ru.rybinsk.silhouette.binding.SpanModel;
...
public class CellSpanTable extends JTable {
    ...
    private static final long serialVersionUID = -1817238930022003976L;
    ...
    public Rectangle getCellRect(int row, int column, boolean includeSpacing) {
        ...
        if (cellSpan != null
                && ((row >= cellSpan.getRow() && (column >= cellSpan.getColumn() && !(row == cellSpan.getRow() && column == cellSpan
                        .getColumn()))))) {
